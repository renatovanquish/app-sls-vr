            ...
            <div className="grid grid-cols-3">
              <div className="cursor-pointer col-span-2">
                ...
                <div style={{
                    ...
                    src={currentItem.thumbnail ? `${process.env.MIDIA_CLOUDFRONT}${currentItem.thumbnail}` : '/images/no_photo.png'}
                  ...
                  >
                    <h2 className={cn("capitalize text-accent-9 font-semibold text-lg hover:text-tertiary-2", {
                    ...
                    <div className="flex mt-1 gap-2 text-xs">
                      ...
                      {currentItem.isSub && <div className="bg-violet-500 text-white px-1 rounded">
                        Sub-categoria
                      </div>}
                    </div>
                  </div>
